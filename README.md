...
This is just a re-upload of the previous project of NimmLor, which is based on the work of jasoncoon's Fastled Webser.
Added a configuration.h file to make things straight forward for non-advanced users.
